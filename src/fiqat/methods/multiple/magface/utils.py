"""This is a modified but (practially) functionally identical copy of
<https://github.com/IrvingMeng/MagFace/blob/0722687e2efe911d1c960d4d7c3cbc615970a63b/utils/utils.py>.
The MagFace repository code has the Apache License 2.0.

NOTE This module isn't actually used at the moment (it could be removed).
...
def adjust_learning_rate(optimizer, epoch, args):
  ...
  lr = args.lr * decay
  global current_lr  # pylint: disable=global-variable-undefined
  current_lr = lr
